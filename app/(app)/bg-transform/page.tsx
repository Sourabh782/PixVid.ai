...
const BgRemove = () => {
  ...
  const [prompt, setPrompt] = useState("volcano");
          ...
          <div className="form-control">
            ...
            <label className="form-control w-full mt-4">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  <input type="text" placeholder="Type here" onChange={(e)=> setPrompt(e.target.value)} className="input input-bordered w-full" />
                </div>
            </label>
          </div>
